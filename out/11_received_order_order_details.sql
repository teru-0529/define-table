...
-- Set FK Constraint
ALTER TABLE received_order.order_details DROP CONSTRAINT IF EXIST order_details_foreignKey_1;
...
ALTER TABLE received_order.order_details DROP CONSTRAINT IF EXIST order_details_foreignKey_2;
